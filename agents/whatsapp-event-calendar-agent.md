...
**הערה פתוחה שטרם הוכרעה:** מה קורה כשמגיעות כמה תשובות reply *סותרות*
לאותה הצעה (`replyTo.id` זהה) — לדוגמה תשובה שנייה שסותרת תשובה ראשונה?
המפרט הנוכחי ("Approval Flow" למעלה) לא מגדיר סדר עדיפות. יש להכריע בכך
(ולתעד כאן) לפני שמנגנון האישור נסמך על כך אוטומטית ללא בדיקה ידנית נוספת.
